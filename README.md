...
| 系級 | 學號 | 組員 | 負責項目 |
|------|------|------|------------|
| 資管四B | 411630261 | 黃俞媞 | HTML 結構設計、Bootstrap 版面配置、JavaScript 互動功能、localStorage、表單驗證 |
| 資管四B | 412637737 | 簡宥莉 | CSS 設計、深色模式 |
| 資管四C | 408630811 | 蒲羿妃 | CSS 設計、RWD、JavaScript 互動功能 |
